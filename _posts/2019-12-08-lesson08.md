...
2. Write each of the functions:
    ...
    * A function which takes in a an input Y, prints out all numbers 1 - 10 which evenly divide that number, and returns the total number of numbers that you printed. For example, for the number 12, it should print out `1, 2, 3, 4, 6` and return the number `5`.
    <details><summary>Hint</summary>Try breaking down the problem into steps. <details><summary>Hint</summary>{{hint-0 | markdownify }}</details></details><br />
