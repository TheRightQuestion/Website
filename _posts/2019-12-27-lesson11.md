...
int main() {
    Budget limit_other = FromUser();
    Budget limit_shopping = FromUser();
    Budget limit_transportation = FromUser();

    Purcase item0 = FromUser();
    Purcase item1 = FromUser();
    Purcase item2 = FromUser();
